import { t } from './i18n';
export const SITE_RULE_SET_BASE_URL = 'https://edgeone.gh-proxy.com/https://github.com/lyc8503/sing-box-rules/blob/rule-set-geosite/geosite-cn.srs';
export const IP_RULE_SET_BASE_URL = 'https://edgeone.gh-proxy.com/https://github.com/lyc8503/sing-box-rules/blob/rule-set-geoip/geoip-cn.srs';
